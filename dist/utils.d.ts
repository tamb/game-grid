export declare function getKeyByValue(object: any, value: string): string | undefined;
export declare function renderAttributes(el: HTMLElement, tuples: [string, string][]): void;
export declare function getCoordsFromElement(el: HTMLElement): number[] | undefined;

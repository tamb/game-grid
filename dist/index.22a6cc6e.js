...
})({"6iAyU":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8f48376c22a6cc6e";
"use strict";
...
var _collectionMazeJs = require("./collectionMaze.js");
document.addEventListener("DOMContentLoaded", function() {
    ...
    (0, _collectionMazeJs.createCoinGrid)();
});

},{"./styles.scss":"lmQZg","./eventListeners.js":"lrKal","./maze.js":"eUgdR","./grid1.js":"6oAsK","./collectionMaze.js":"cV1Qp"}],"lmQZg":[function() {},{}],"lrKal":[function(require,module,exports) {
    ...
    var o = {
        ...
        function t(t, r) {
            ...
            this.state = s, this.refs = {
                ...
                n.options.arrowControls && ("ArrowUp" !== t.code && "ArrowRight" !== t.code && "ArrowDown" !== t.code && "ArrowLeft" !== t.code || (t.preventDefault(), n.handleDirection(t))), n.options.wasdControls && ("KeyW" !== t.code && "KeyD" !== t.code && "KeyS" !== t.code && "KeyA" !== t.code || (t.preventDefault(), n.handleDirection(t)));
                ...
                n.options.activeClass && n.refs.container.classList.add(n.options.activeClass);
            }, this.containerBlur = function() {
                n.options.activeClass && n.refs.container.classList.remove(n.options.activeClass);
            }, this.options = e({
        ...
        return t.prototype.renderGrid = function(t) {
            ...
            return this.refs.cells[this.state.activeCoords[0]][this.state.activeCoords[1]];
            ...
            this.matrix.forEach(function(e, o) {
                ...
                t.options.rowClass && r.classList.add(t.options.rowClass), r.setAttribute("data-gamegrid-row-index", o.toString()), r.setAttribute("data-gamegrid-ref", "row"), r.classList.add("gamegrid__row"), null === (s = t.refs) || void 0 === s || s.cells.push([]), e.forEach(function(i, s) {
            ...
            t.unshift(this.state.activeCoords), t.length > this.options.rewindLimit && t.shift(), this.setStateSync({
                moves: t
            });
        }, t.prototype.testLimit = function() {
            var t = this.state.nextCoords[0], e = this.state.nextCoords[1], s = this.matrix.length - 1, l = this.matrix[this.state.activeCoords[0]].length - 1;
            switch(this.state.currentDirection){
                case n:
                    this.state.nextCoords[0] > s && (this.options.infiniteY ? (t = 0, i.call(this, o.WRAP_Y), i.call(this, o.WRAP)) : (t = s, i.call(this, o.LIMIT_Y), i.call(this, o.LIMIT)));
                    break;
                case a:
                    this.state.nextCoords[1] < 0 && (this.options.infiniteX ? (e = l, i.call(this, o.WRAP_X), i.call(this, o.WRAP)) : (e = 0, i.call(this, o.LIMIT_X), i.call(this, o.LIMIT)));
                    break;
                case c:
                    this.state.nextCoords[1] > l && (this.options.infiniteX ? (e = 0, i.call(this, o.WRAP_X), i.call(this, o.WRAP)) : (e = l, i.call(this, o.LIMIT_X), i.call(this, o.LIMIT)));
                    break;
                case r:
                    this.state.nextCoords[0] < 0 && (this.options.infiniteY ? (t = s, i.call(this, o.WRAP_Y), i.call(this, o.WRAP)) : (t = 0, i.call(this, o.LIMIT_Y), i.call(this, o.LIMIT)));
            }
            this.setStateSync({
                nextCoords: [
                    t,
            ...
            var t, e = this.state.nextCoords;
            "open" === (null === (t = this.matrix[e[0]][e[1]]) || void 0 === t ? void 0 : t.type) && "interactive" === this.matrix[this.state.prevCoords[0]][this.state.prevCoords[1]].type && i.call(this, o.MOVE_DETTACH);
...
},{}],"eUgdR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Function to generate a 2D maze
parcelHelpers.export(exports, "generateMaze", ()=>generateMaze);
...
},{"../dist/main":"lbDgN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6oAsK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const matrix = [
    [
        {
            type: (0, _enums.tileTypeEnum).OPEN,
            cellAttributes: [
                [
                    "data-butt",
                    "sauce"
        ...
        {
            type: (0, _enums.tileTypeEnum).INTERACTIVE,
            cellAttributes: [
                [
                    "data-cell-type",
                    "interactive"
    ...
    [
        ...
        {
            type: (0, _enums.tileTypeEnum).BARRIER,
            cellAttributes: [
                [
                    "data-cell-type",
                    "barrier"
...
},{"../dist/main":"lbDgN","./enums":"eeJiB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eeJiB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cV1Qp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createCoinGrid", ()=>createCoinGrid);
var _main = require("./../dist/main");
var _mainDefault = parcelHelpers.interopDefault(_main);
...
function createCoinGrid() {
    ...
    coinGrid.matrix.forEach((row, rowIndex)=>{
        row.forEach((cell, cellIndex)=>{
            if (cell.type === "interactive") coinGrid.refs.cells[rowIndex][cellIndex].innerHTML = `<game-coin></game-coin>`;
        });
    });
...
},{"./../dist/main":"lbDgN","./maze":"eUgdR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6iAyU","38PNf"], "38PNf", "parcelRequiredb3a")

//# sourceMappingURL=index.22a6cc6e.js.map
